...
const {createOneComment, createManyComments,
    readAllComments, readAllCommentsByItinerary, readOneCommentById, readOneCommentByName,
    updateOneComment, deleteOneComment} = CommentsController;
